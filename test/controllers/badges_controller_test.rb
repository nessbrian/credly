...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { badge_id: @badge.badge_id, badge_template_id: @badge.badge_template_id, issued_to: @badge.issued_to, recipient_email: @badge.recipient_email } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { badge_id: @badge.badge_id, badge_template_id: @badge.badge_template_id, issued_to: @badge.issued_to, recipient_email: @badge.recipient_email } }
